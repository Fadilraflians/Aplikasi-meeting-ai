...
export const EyeOffIcon = ({ className = "w-5 h-5 text-gray-400" }: { className?: string }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7 1.274-4.057 5.064-7 9.542-7 .847 0 1.673.123 2.458.35M18.428 5.572A10.015 10.015 0 0121.542 12c-1.274 4.057-5.064 7-9.542 7a10.015 10.015 0 01-1.857-.175M5.571 18.429a10.005 10.005 0 01-3.113-6.429M2 2l20 20"></path>
    </svg>
);

export const ChatIcon = ({className = "w-8 h-8"}) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
