                    ...
                    <div className="absolute top-3 right-3">
                        {(() => {
                            ...
                            if (room.isActive === false) {
                                return (
                                    <div className="px-3 py-1.5 rounded-full text-xs font-semibold bg-gradient-to-r from-red-500 to-red-600 text-white shadow-lg border border-red-400">
                        ...
                        {room.isActive === false && (
                            <div className={`flex items-center gap-2 p-3 rounded-lg border ${
                                ...
                                <div className={`w-6 h-6 rounded-full flex items-center justify-center ${
                                    ...
                                    <svg className={`w-3 h-3 ${isDarkMode ? 'text-red-400' : 'text-red-600'}`} fill="currentColor" viewBox="0 0 20 20">
                                        <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                                    </svg>
                                </div>
                                <div>
                                    <div className={`text-xs font-medium ${isDarkMode ? 'text-red-400' : 'text-red-600'}`}>Status Ruangan</div>
                                    <div className={`text-sm font-semibold ${isDarkMode ? 'text-red-300' : 'text-red-700'}`}>Ruangan sedang dalam perawatan</div>
                                </div>
                            </div>
                        )}
